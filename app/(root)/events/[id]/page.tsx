    ...
    <section className='flex justify-center bg-primary-50 bg-dotted-pattern bg-contain'>
      <div className='grid grid-cols md:grid-cols-2 2xl:max-w-7xl'>
        ...
        <div className='flex w-full flex-col gap-8 p-5 md:p-10'>
          <div className='flex flex-col gap-6'>
            ...
            <div className='flex flex-col gap-3 sm:flex-row items-center'>
              <div className='flex gap-3'>
                ...
                <p className='p-medium-16 rounded-fu;; bg-gray-500/10 px-4 py-2.5 text-grey-500'>
                  {event.category.name}
                </p>
              </div>
          ...
          <CheckoutButton event={event} id={id} />
          <div className='flex flex-col gap-5'>
            <div className='flex gap-2 md:gap-3'>
              <Image
                ...
                height={32}
              />
              <div className='flex flex-col p-medium-16 items-center lg:p-regular-20'>
                <p>
                  From {formatDateTime(event.startDateTime).dateOnly}-{" "}
